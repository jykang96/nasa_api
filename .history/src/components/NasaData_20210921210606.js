                        ...
                        <div class="flex flex-col w-full rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5 py-5 justify-self-center">
                            ...
                            <div class="flex flex-col w-full md:flex-row">
                                    ...
                                    <div class="p-4 font-normal text-gray-800 md:w-3/4">
                                        ...
                                        <button class="bg-blue-500 hover:bg-blue-light text-white font-bold py-2 px-4 border-b-4 border-blue-dark hover:border-blue rounded justify-self-center">Like</button>
                                    </div>
                            </div>
                        </div>
                    ))}
