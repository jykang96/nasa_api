...
const NasaPhoto = () => {
    ...
    return (
        <Fragment>
            <div className="grid grid-cols-2 bg-light-blue justify-center align-middle">
                <div class="justify-center">
                    {photoData.map((data) => (
                        <div class="flex flex-col w-full rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5 py-5">
                            ...
                            <div class="flex flex-col w-full md:flex-row">
                                    <div class="flex flex-row justify-around p-4 font-bold leading-none text-gray-800 uppercase bg-gray-400 rounded md:flex-col md:items-center md:justify-center md:w-1/4">
                                        <div className="text-center">Posted On</div>
