...
const NasaPhoto = () => {
    ...
    function focus(){
        console.log(buttonRef.current.key)
    }
        ...
        <div className="bg-gray-50 nasa-font">
            ...
            <div className="grid xl:grid-cols-2 lg:grid-cols-1 content-center items-center">
                    ...
                    {photoData.map((data, i) => (
                        <div class="flex flex-col w-full rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5 py-5 justify-self-center" key={i}>
                            ...
                            <div class="flex flex-col w-full md:flex-row">
                                    ...
                                    <div class="p-4 font-normal text-gray-800 md:w-3/4">
                                        ...
                                        <div className="grid items-center pt-2">
                                            <button className="py-3 px-5 text-xl button" key={i} onClick={focus} ref={buttonRef}>Like</button>
                                        </div>
                                    </div>
                            </div>
                        </div>
