...
const NasaPhoto = () => {
    ...
    let btn = document.createElementById('btn');
                        ...
                        <div class="flex flex-col w-full rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5 py-5 justify-self-center" key={data.url}>
                            ...
                            <div class="flex flex-col w-full md:flex-row">
                                    ...
                                    <div class="p-4 font-normal text-gray-800 md:w-3/4">
                                        ...
                                        <svg id="check" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
